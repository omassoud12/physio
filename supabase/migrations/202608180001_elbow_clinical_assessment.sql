-- Add the elbow module to the existing versioned clinical-assessment system.
do $$
...
alter table public.clinical_assessments
  add constraint clinical_assessments_type_supported
    check (assessment_type in ('shoulder_quick_assessment','elbow_quick_assessment')),
  add constraint clinical_assessments_region_type_match
    check (
